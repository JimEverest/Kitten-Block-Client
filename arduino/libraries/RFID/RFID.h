...
#ifndef RFID_TRANSFER_MODE
//#define RFID_TRANSFER_MODE RFID_I2C
//#define RFID_TRANSFER_MODE RFID_SPI
#define RFID_TRANSFER_MODE RFID_UART
#endif
...
#if RFID_TRANSFER_MODE == RFID_I2C
	#include <Wire.h>
	#define MFR_DEVICE_ADDRESS 0x2F //0x28
#endif
#if RFID_TRANSFER_MODE == RFID_SPI
	#include <SPI.h>
#endif

#define RFID_I2C	1//I2C interface
#define RFID_SPI	2//SPI interface
#define RFID_UART	3//UART interface
